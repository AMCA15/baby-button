...
// XXX: Copied from main, this is not the best approach. You need two change this defines in BOTH files
#define APP_ADV_INTERVAL           300           /**< The advertising interval (in units of 0.625 ms. This value corresponds to 187.5 ms). */
#define APP_ADV_DURATION           18000         /**< The advertising duration (180 seconds) in units of 10 milliseconds. */

static ble_advertising_t * p_advertising;
...
/**
 * @brief This is a workaround for get the m_adversiting from the main file
 *       and made it accesible inside the buttonless file
 * 
