PROJECT_NAME     := ble_app_gls_pca10056_s140
...
$(OUTPUT_DIRECTORY)/nrf52840_xxaa.out: \
  LINKER_SCRIPT  := ble_app_nrf52.ld

# Source files common to all targets
SRC_FILES += \
  $(PROJ_DIR)/lib/ble_mas/ble_mas.c \
  $(PROJ_DIR)/lib/LSM9DS1/SparkFunLSM9DS1.c \
  $(PROJ_DIR)/src/buttonless.c \
  $(PROJ_DIR)/src/main.c \
  $(PROJ_DIR)/src/sensors.c \
  $(PROJ_DIR)/src/ble_sec.c \
...
INC_FOLDERS += \
  $(PROJ_DIR)/include \
  $(PROJ_DIR)/lib/ble_mas \
  $(PROJ_DIR)/lib/LSM9DS1 \
  $(SDK_ROOT)/components \
